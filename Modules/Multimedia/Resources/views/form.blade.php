                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <button class="btn btn-default btn-sm"><a href="{{Route('viewmultimedia')}}"
                                                                   style="color: #e20909;">
                    ...
                    @if(isset($data['multimedia']))
                        {!! Form::model($data['multimedia'],[
                                'url' =>route('updatemultimedia',$data['multimedia']->id),
                                'enctype' => 'multipart/form-data',
                                'onsubmit'=>"return checkForm(this)"
                        ]) !!}
                    @else
                        {!!Form::open([
                                'url' => route('addmultimedia'),
                                'enctype' => 'multipart/form-data',
                                'role' => 'form',
                                 'onsubmit'=>"return checkForm(this)"
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                @if(isset($data['multimedia']))
                                    <div class="col-lg-6">
                                        <img
                                            src="{{asset('public/images/multimedia/'.$data['multimedia']->$_databaseimage)}}"
                                            alt="multimedia image" style="width: 50px; height: 50px">
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Image:</label>
